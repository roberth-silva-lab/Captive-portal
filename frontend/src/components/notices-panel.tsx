...
export function NoticeAdminPanel({ notices, allowedSites = [], selectedSiteId = 'ALL', canSelectAllSites = false, compact = false, onChanged }: { notices: AdminNotice[]; allowedSites?: AllowedSite[]; selectedSiteId?: string; canSelectAllSites?: boolean; compact?: boolean; onChanged?: () => Promise<void> }) {
